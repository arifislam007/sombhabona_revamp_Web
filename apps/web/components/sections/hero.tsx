...
export function Hero({ t }: { t: Dict }) {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      <Image
        src={IMGS.hero}
        alt="Children learning at a Sombhabona program"
        fill
        priority
        sizes="100vw"
      ...
      <motion.div
        ...
        className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 text-center text-white pt-20"
      >
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <motion.button
            ...
            className="flex items-center justify-center gap-2 bg-accent hover:bg-orange-600 text-white px-8 py-4 rounded-full font-bold text-lg transition-colors shadow-lg shadow-orange-500/30 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-primary"
          >
